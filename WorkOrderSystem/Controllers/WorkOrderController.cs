...
namespace MyApp.Namespace
{
    ...
    public class WorkOrdersController(IWorkOrderRepository workOrderRepository) : ControllerBase
    {
        ...
        public async Task<ActionResult<IReadOnlyList<WorkOrder>>> GetWorkOrdersByTechnicianId(
            int id
        )
        {
        ...
        public async Task<ActionResult<IReadOnlyList<WorkOrder>>> GetWorkOrdersByStatus(
            string status
        )
        {
        ...
        {
            var result = await _workOrderRepository.UpdateWorkOrderStatusAsync(
                id,
                workOrderUpdateDto
            );
